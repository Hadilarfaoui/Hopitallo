 ...
 */
final class Version20230207194313 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE service ADD hopital_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_E19D9AD2CC0FBF92 ON service');
        $this->addSql('ALTER TABLE service DROP hopital_id');
    }
}
