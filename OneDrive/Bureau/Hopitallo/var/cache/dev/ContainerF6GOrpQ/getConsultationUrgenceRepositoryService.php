 ...
 */
class getConsultationUrgenceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ConsultationUrgenceRepository' shared autowired service.
     *
     * @return \App\Repository\ConsultationUrgenceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ConsultationUrgenceRepository.php';

        return $container->privates['App\\Repository\\ConsultationUrgenceRepository'] = new \App\Repository\ConsultationUrgenceRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
