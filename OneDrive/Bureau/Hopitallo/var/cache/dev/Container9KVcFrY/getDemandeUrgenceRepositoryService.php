 ...
 */
class getDemandeUrgenceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DemandeUrgenceRepository' shared autowired service.
     *
     * @return \App\Repository\DemandeUrgenceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DemandeUrgenceRepository.php';

        return $container->privates['App\\Repository\\DemandeUrgenceRepository'] = new \App\Repository\DemandeUrgenceRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
